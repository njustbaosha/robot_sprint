...
/*
 * Some of these declarations are new in C99.  To access them regardless of
 * selected standard you can use -D__USE_C99_MATH (or -D__USE_C99_ALL).
 */
#ifndef __USE_C99_MATH
  #if defined(__USE_C99_ALL) || (defined(__STDC_VERSION__) && 199901L <= __STDC_VERSION__) || defined(__cplusplus)
...
#undef _ARMDEFLD2
  ...
  #ifdef _NOEXCEPT
    #define _ARM_NOEXCEPT _NOEXCEPT
  #else
    #define _ARM_NOEXCEPT
  #endif

  extern "C++" {
    _ARM_NODISCARD_EXT inline int (fpclassify)(double __x) _ARM_NOEXCEPT { return fpclassify(__x); }
    _ARM_NODISCARD_EXT inline bool (isfinite)(double __x) _ARM_NOEXCEPT { return isfinite(__x); }
    _ARM_NODISCARD_EXT inline bool (isgreater)(double __x, double __y) _ARM_NOEXCEPT { return isgreater(__x, __y); }
    _ARM_NODISCARD_EXT inline bool (isgreaterequal)(double __x, double __y) _ARM_NOEXCEPT { return isgreaterequal(__x, __y); }
    _ARM_NODISCARD_EXT inline bool (isinf)(double __x) _ARM_NOEXCEPT { return isinf(__x); }
    _ARM_NODISCARD_EXT inline bool (isless)(double __x, double __y) _ARM_NOEXCEPT { return isless(__x, __y); }
    _ARM_NODISCARD_EXT inline bool (islessequal)(double __x, double __y) _ARM_NOEXCEPT { return islessequal(__x, __y); }
    _ARM_NODISCARD_EXT inline bool (islessgreater)(double __x, double __y) _ARM_NOEXCEPT { return islessgreater(__x, __y); }
    _ARM_NODISCARD_EXT inline bool (isnan)(double __x) _ARM_NOEXCEPT { return isnan(__x); }
    _ARM_NODISCARD_EXT inline bool (isnormal)(double __x) _ARM_NOEXCEPT { return isnormal(__x); }
    _ARM_NODISCARD_EXT inline bool (isunordered)(double __x, double __y) _ARM_NOEXCEPT { return isunordered(__x, __y); }
